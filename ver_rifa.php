            ...
            <?php if (!empty($rifa['imagen1']) || !empty($rifa['imagen2'])): ?>
                <div class="rifa-images">
                    ...
                    <?php if (!empty($rifa['youtube_link'])): ?>
                        <a href="<?php echo htmlspecialchars($rifa['youtube_link']); ?>" target="_blank" class="youtube-link">Ver Video del Premio</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        ...
        <?php if ($modo_admin): ?>
            <div id="adminControls" class="admin-controls">
                <form method="POST" action="">
                    <input type="text" id="nombreParticipante" name="nombre" placeholder="Ingrese el nombre del participante" class="input-nombre" required>
                    <input type="email" id="emailParticipante" name="email" placeholder="Email del participante (opcional)" class="input-nombre">
                    <input type="tel" id="telefonoParticipante" name="telefono" placeholder="Teléfono del participante (opcional)" class="input-nombre">
